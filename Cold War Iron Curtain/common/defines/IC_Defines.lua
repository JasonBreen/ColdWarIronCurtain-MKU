...
NDefines.NDiplomacy.TENSION_ANNEX_NO_CLAIM = 0.01 -- Amount of tension generated by annexing a state you DO have claims on
NDefines.NDiplomacy.TENSION_ANNEX_CLAIM = 0.075 -- Amount of tension generated by annexing a state you DO have claims on
NDefines.NDiplomacy.TENSION_ANNEX_CORE = 0.05 -- Amount of tension generated by annexing a state that is your core
...
NDefines.NMilitary.MAX_DIVISION_SUPPORT_HEIGHT = 10 -- Max width of support in division designer.
...
NDefines.NMilitary.MIN_DIVISION_BRIGADE_HEIGHT = 5 -- Unlocks max brigade height in division designer by default to better align with starting templates
...
NDefines.NOperatives.AGENCY_CREATION_DAYS = 10000000
NDefines.NOperatives.AGENCY_UPGRADE_DAYS = 10000000
NDefines.NOperatives.AGENCY_OPERATIVE_RECRUITMENT_TIME = 0
NDefines.NOperatives.AGENCY_CREATION_FACTORIES = 10000000
...
NDefines.NPolitics.NAVY_LEADER_MAX_COST = 220				-- max cost BEFORE modifiers
