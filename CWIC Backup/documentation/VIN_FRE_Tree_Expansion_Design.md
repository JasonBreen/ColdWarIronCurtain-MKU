...
- Begin Operation Pollux as the next unimplemented named operation in the historical spine. Design it as the Lai Chau evacuation/retreat into the established Dien Bien Phu position, with force-preservation and column-loss outcomes feeding the later garrison; do not put Pollux back into the generic arbitrary-border-war wrapper.
